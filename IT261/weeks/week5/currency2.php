...
<body>
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (empty($_POST['amount'])) {
            echo '<span class="error">Please fill out your amount! 
            A "Zero" value will not work!</span>';
        }
        if (empty($_POST['currency'])) {
            echo '<span class="error">Please choose you currency!</span>';
        }
        if ($_POST['bank'] == NULL) {
            echo '<span class="error">Please choose your banking instituition</span>';
        }
