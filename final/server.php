...
// this server.php page will be commnucating to our database
...
if (isset($_POST['reg_user'])) {
    ...
    // bottom line is, we cannot have duplicate usernames or emails
    if ($rows) {
...
// Now, we must communicate with the login page 
